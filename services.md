...
-   Mise en place, constitution et administration de bases
    bibliographiques
-   Relecture, mise à niveau et mise en forme de données
    bibliographiques : bibliographies, listes personnelles de
    publications sous tout format (CV statique, profil en ligne ORCID ou
    autre), listes de références selon les consignes d'un éditeur, etc.
...
et la [documentation
associée](https://documentation-style-csl-ed-droit-ubx.readthedocs.io/en/latest/),
incluant une base bibliographique d'exemples - Projet présenté dans [la
...
-   Recherches documentaires dans les bases de données (PubMed, Scopus,
    Web of Science, etc.), catalogues en ligne, moteurs de recherche,
    etc.
...
-   [Projet CONHECS-IT](https://cohnecsit.mnhn.fr/) porté par le Muséum
    ...
    recherche et la gestion bibliographiques

-   Revues de littérature en santé (mention dans les remerciements) :

    -   Clet, E., Leblanc, P., Alla, F., & Cohidon, C. (2024). Factors
        for the integration of prevention in primary care : An overview
        of reviews. *BJGP Open*. https://doi.org/10.3399/BJGPO.2023.0141
    -   Ségard, E., Chervin, P., & Cambon, L. (2024). Framework to
        support the transfer of innovative interventions in the
        disability field : lessons from the transferability of complex
...
-   Traduction et création de pages pour la [Documentation Zotero
    Fr](https://docs.zotero-fr.org/)
-   Billets pour le [blog Zotero
    francophone](https://zotero.hypotheses.org/) sur la plateforme
    Hypothèses 